...
### Functional Design Analyst @ Movistar Argentina → Solutions Architect / Cloud
...
Mi objetivo es correrme del perfil de analista funcional puro hacia uno de **Arquitecto de Soluciones / Cloud**.

---

### 🚀 En foco ahora

- 🔧 Preparando **AZ-900** (examen en octubre)
- ☁️ Próximo paso: **AWS Certified Solutions Architect – Associate (SAA-C03)**
- 📐 Modelado de arquitectura con C4 Model, BPM y eTOM en proyectos de telecomunicaciones
...
![C4 Model](https://img.shields.io/badge/C4_Model-1E88E5?style=for-the-badge&logo=diagramsdotnet&logoColor=white)
